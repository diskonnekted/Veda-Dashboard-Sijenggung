...
def main():
    if not os.path.exists('arcgis_webmap_new.json'):
        print("arcgis_webmap_new.json not found!")
        return

    with open('arcgis_webmap_new.json', 'r') as f:
        data = json.load(f)
        
    layers_to_extract = {
        "krb_i": "krb_1.geojson",
        "krb_ii": "krb_2.geojson",
        "krb_iii": "krb_3.geojson",
        "jalur_evakuasi": "evacuation_route.geojson",
        "lokasi_ews": "ews_location.geojson",
        "barak_pengungsian": "barracks.geojson",
        "titik_kumpul": "assembly_points.geojson",
        "jarak_merapi": "merapi_distance.geojson"
    }
